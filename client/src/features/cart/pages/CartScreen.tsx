...
const CartScreen: React.FC = () => {
  ...
  return (
    <div
      className="main-content"
      style={{ maxWidth: 600, margin: "0 auto", padding: "2rem 0" }}
    >
      <h2>{t("cart") || "Cart"}</h2>
      <Table
        columns={[
          ...
          },
          {
            ...
            label: t("quantity"),
            render: (item) => {
              const menuItem: MenuItem | undefined = menuItemService.getById(
                item.id
              );
      ...
      />
      <div style={{ fontWeight: 600, fontSize: 18, margin: "1rem 0" }}>
        {t("total") || "Total"}: {total} ₪
      </div>
      <Button
